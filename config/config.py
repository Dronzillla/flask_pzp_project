...
class Config:
    ...
    DB_COLUMN_MAP = {
        ...
        # Ratios
        "enis": "Economic benefit-cost ratio",
        "egdv": "Economic net present value",
        "evgn": "Economic internal rate of return",
        "sva": "Cost effectiveness ratio",
        "da": "Multicriteria analysis ratio",
        "fgdv": "Financial net present value",
        "fvgn": "Financial internal rate of return",
        "fnis": "Financial benefit-cost ratio",
        # Cashflows
